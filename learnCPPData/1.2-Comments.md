...
> **Author:** Alex
> **Date:** Alex May 30, 2007, 4:17 pm PDT March 19, 2025
...
- Full programs (those with a `main()` function). These are ready to be compiled and run.
`main()`- Snippets (small pieces) of code, such as the statements above. We use these to demonstrate specific concepts in a concise manner.
...
We discuss commenting for variable declaration statements in lesson [1.7 -- Keywords and naming identifiers](https://www.learncpp.com/cpp-tutorial/keywords-and-naming-identifiers/).
...
- At the library, program, or function level, use comments to describe *what*.
*what*- Inside the library, program, or function, use comments to describe *how*.
*how*- At the statement level, use comments to describe *why*.

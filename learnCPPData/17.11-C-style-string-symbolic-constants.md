...
> **Author:** Alex
> **Date:** Alex August 15, 2015, 4:46 pm PDT October 25, 2023

---

In the previous lesson ([17.10 -- C-style strings](https://www.learncpp.com/cpp-tutorial/c-style-strings/)), we discussed how to create and initialize C-style string objects:
...
We cover `void*` in lesson [19.5 -- Void pointers](https://www.learncpp.com/cpp-tutorial/void-pointers/). You don’t need to know how it works to use it here.

Favor std::string\_view for C-style string symbolic constants

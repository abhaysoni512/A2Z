...
> **Author:** Alex
> **Date:** Alex September 11, 2023, 1:58 pm PDT August 13, 2024
...
- We will use `container classes` when we’re talking about something that applies to most or all the standard library containers classes.
`container classes`- We will use `array` when we’re talking about something that generally applies to all array types, even ones implemented in other programming languages.

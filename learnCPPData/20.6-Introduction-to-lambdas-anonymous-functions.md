...
> **Author:** nascardriver
> **Date:** nascardriver January 3, 2020, 5:19 am PST June 14, 2024

---

Consider this snippet of code that we introduced in lesson [18.3 -- Introduction to standard library algorithms](https://www.learncpp.com/cpp-tutorial/introduction-to-standard-library-algorithms/):
...
- If C++20 capable, use `auto` as the parameter’s type.
`auto`- Otherwise, use a function with a type template parameter or `std::function` parameter (or a function pointer if the lambda has no captures).

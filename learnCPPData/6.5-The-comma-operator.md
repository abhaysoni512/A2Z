...
> **Author:** Alex
> **Date:** Alex June 14, 2007, 7:41 am PDT October 24, 2023
...
| Comma | , | x, y | Evaluate x then y, returns value of y |
| Operator | Symbol | Form | Operation |
 Operator | Symbol | Form | Operation || Comma | , | x, y | Evaluate x then y, returns value of y |
 Comma | , | x, y | Evaluate x then y, returns value of y |
...
Most programmers do not use the comma operator at all, with the single exception of inside *for loops*, where its use is fairly common. We discuss for loops in future lesson [8.10 -- For statements](https://www.learncpp.com/cpp-tutorial/for-statements/).

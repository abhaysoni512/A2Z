...
> **Author:** Alex
> **Date:** Alex December 14, 2007, 4:54 pm PST December 30, 2024
...
- When performing resize or insertion operations, move elements only if their move constructor is noexcept, otherwise copy them ([27.10 -- std::move\_if\_noexcept](https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/)).
- Provide a strong exception safety guarantee for resize or insertion operations ([27.9 -- Exception specifications and noexcept](https://www.learncpp.com/cpp-tutorial/exception-specifications-and-noexcept/)).

- When performing resize or insertion operations, move elements only if their move constructor is noexcept, otherwise copy them ([27.10 -- std::move\_if\_noexcept](https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/)).
[27.10 -- std::move\_if\_noexcept](https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/)- Provide a strong exception safety guarantee for resize or insertion operations ([27.9 -- Exception specifications and noexcept](https://www.learncpp.com/cpp-tutorial/exception-specifications-and-noexcept/)).

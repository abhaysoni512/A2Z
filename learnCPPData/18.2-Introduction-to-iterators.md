...
> **Author:** Alex
> **Date:** Alex December 17, 2019, 10:38 am PST February 11, 2025
...
In lesson [8.10 -- For statements](https://www.learncpp.com/cpp-tutorial/for-statements/), we noted that using `operator<` was preferred over `operator!=` when doing numeric comparisons in the loop condition:

...
> **Author:** Alex
> **Date:** Alex June 15, 2007, 1:35 pm PDT November 26, 2024
...
| false | true |
| Logical NOT (operator !) | |
 Logical NOT (operator !) | || Operand | Result |
 Operand | Result || true | false |
...
New programmers sometimes confuse the *logical OR* operator (||) with the *bitwise OR* operator (|) (covered in lesson [O.2 -- Bitwise operators](https://www.learncpp.com/cpp-tutorial/bitwise-operators/)). Even though they both have *OR* in the name, they perform different functions. Mixing them up will probably lead to incorrect results.
...
[De Morgan’s laws](https://en.wikipedia.org/wiki/De_Morgan%27s_laws) tell us how the *logical NOT* should be distributed in these cases:
...
If you need a form of *logical XOR* that works with non-Boolean operands, you can static\_cast your operands to bool:
...
| ! | not |
| Operator name | Keyword alternate name |
 Operator name | Keyword alternate name || && | and |
 && | and || || | or |
 || | or || ! | not |
 ! | not |
...
In lesson [6.3 -- Remainder and Exponentiation](https://www.learncpp.com/cpp-tutorial/remainder-and-exponentiation/), we wrote a function to determine whether a number is even that looked like this:

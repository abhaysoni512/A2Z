...
> **Author:** Alex
> **Date:** Alex September 14, 2015, 3:44 pm PDT September 9, 2024
...
Another common use for pointers to pointers is to facilitate dynamically allocated multidimensional arrays (see [17.12 -- Multidimensional C-style Arrays](https://www.learncpp.com/cpp-tutorial/multidimensional-c-style-arrays/) for a review of multidimensional arrays).

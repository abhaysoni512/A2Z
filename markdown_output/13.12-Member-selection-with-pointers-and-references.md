...
> **Author:** Alex
> **Date:** Alex July 17, 2007, 11:40 am PDT July 2, 2024

---

Member selection for structs and references to structs

In lesson [13.7 -- Introduction to structs, members, and member selection](https://www.learncpp.com/cpp-tutorial/introduction-to-structs-members-and-member-selection/), we showed that you can use the member selection operator (.) to select a member from a struct object:

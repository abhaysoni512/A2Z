...
> **Author:** Alex
> **Date:** Alex August 30, 2007, 9:42 am PDT February 10, 2025
...
- Where we declare (and define) the `print()` function
`print()`- How we call the `print()` function
`print()`- How we access members inside the `print()` function

...
> **Author:** nascardriver
> **Date:** nascardriver January 3, 2020, 5:19 am PST December 4, 2024

---

Capture clauses and capture by value

In the previous lesson ([20.6 -- Introduction to lambdas (anonymous functions)](https://www.learncpp.com/cpp-tutorial/introduction-to-lambdas-anonymous-functions/)), we introduced this example:
...
- Use Random.h ([8.15 -- Global random numbers (Random.h)](https://www.learncpp.com/cpp-tutorial/global-random-numbers-random-h/)) to generate random numbers.
- Use `std::find()` ([18.3 -- Introduction to standard library algorithms](https://www.learncpp.com/cpp-tutorial/introduction-to-standard-library-algorithms/#std_find)) to search for a number in the list.
...
- Use Random.h ([8.15 -- Global random numbers (Random.h)](https://www.learncpp.com/cpp-tutorial/global-random-numbers-random-h/)) to generate random numbers.
[8.15 -- Global random numbers (Random.h)](https://www.learncpp.com/cpp-tutorial/global-random-numbers-random-h/)- Use `std::find()` ([18.3 -- Introduction to standard library algorithms](https://www.learncpp.com/cpp-tutorial/introduction-to-standard-library-algorithms/#std_find)) to search for a number in the list.
[18.3 -- Introduction to standard library algorithms](https://www.learncpp.com/cpp-tutorial/introduction-to-standard-library-algorithms/#std_find)- Use `std::vector::erase()` to remove an element, e.g.

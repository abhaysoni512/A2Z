...
> **Author:** Alex
> **Date:** Alex July 16, 2015, 2:29 pm PDT February 4, 2025
...
`assert` is a preprocessor macro that terminates the program if the associated argument evaluates to false. So when we write `assert(!isPrime(0))`, we’re meaning “if isPrime(0) is true, then terminate the program”. We cover assert in more detail in lesson [9.6 -- Assert and static\_assert](https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/).

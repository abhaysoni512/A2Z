...
> **Author:** Alex
> **Date:** Alex February 1, 2019, 11:57 am PST August 26, 2024
...
Now we can enable debugging simply by commenting / uncommenting *#define ENABLE\_DEBUG*. This allows us to reuse previously added debug statements and then just disable them when we’re done with them, rather than having to actually remove them from the code. If this were a multi-file program, the #define ENABLE\_DEBUG would go in a header file that’s included into all code files so we can comment / uncomment the #define in a single location and have it propagate to all code files.
...
- Visit the [plog](https://github.com/SergiusTheBest/plog) repo.
[plog](https://github.com/SergiusTheBest/plog)- Click the green Code button in the top right corner, and choose “Download zip”

...
> **Author:** Alex
> **Date:** Alex February 1, 2019, 12:03 pm PST October 14, 2024
...
One common method of doing this is via *assert* and *static\_assert*, which we cover in lesson [9.6 -- Assert and static\_assert](https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/).

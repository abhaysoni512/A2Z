...
> **Author:** Alex
> **Date:** Alex September 11, 2023, 3:32 pm PDT August 15, 2024
...
Inside the implementation of `std::get()`, there is a static\_assert that checks to ensure that the non-type template argument is smaller than the array length. If it isn’t, then the static\_assert will halt the compilation process with compilation error.

...
> **Author:** Alex
> **Date:** Alex February 26, 2017, 12:43 pm PST February 18, 2025

---

In lesson [22.1 -- Introduction to smart pointers and move semantics](https://www.learncpp.com/cpp-tutorial/introduction-to-smart-pointers-move-semantics/), we took a look at std::auto\_ptr, discussed the desire for move semantics, and took a look at some of the downsides that occur when functions designed for copy semantics (copy constructors and copy assignment operators) are redefined to implement move semantics.
...
We introduce `noexcept` in lesson [27.9 -- Exception specifications and noexcept](https://www.learncpp.com/cpp-tutorial/exception-specifications-and-noexcept/) and discuss why move constructors and move assignment are marked as `noexcept` in lesson [27.10 -- std::move\_if\_noexcept](https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/).

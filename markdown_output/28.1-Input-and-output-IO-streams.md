...
> **Author:** Alex
> **Date:** Alex February 28, 2008, 4:10 pm PST September 11, 2023
...
**cin**- **cout** -- an ostream object tied to the standard output (typically the monitor)
**cout**- **cerr** -- an ostream object tied to the standard error (typically the monitor), providing unbuffered output
**cerr**- **clog** -- an ostream object tied to the standard error (typically the monitor), providing buffered output

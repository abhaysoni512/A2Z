...
> **Author:** Alex
> **Date:** Alex March 4, 2017, 8:21 pm PST May 8, 2024
...
There is a useful variant of `std::move()` called `std::move_if_noexcept()` that returns a movable r-value if the object has a `noexcept` move constructor, otherwise it returns a copyable l-value. We cover this in lesson [27.10 -- std::move\_if\_noexcept](https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/).

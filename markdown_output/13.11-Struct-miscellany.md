...
> **Author:** Alex
> **Date:** Alex July 21, 2023, 4:09 pm PDT September 25, 2024
...
In lesson [5.9 -- std::string\_view (part 2)](https://www.learncpp.com/cpp-tutorial/stdstring_view-part-2/), we introduced the dual concepts of owners and viewers. Owners manage their own data, and control when it is destroyed. Viewers view someone else’s data, and do not control when it is altered or destroyed.

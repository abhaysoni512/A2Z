...
> **Author:** Alex
> **Date:** Alex June 4, 2007, 9:41 pm PDT February 26, 2025
...
| char wchar\_t char8\_t (C++20) char16\_t (C++11) char32\_t (C++11) | Integral (Character) | a single character of text | ‘c’ |
...
- The **standard integer types** are `short`, `int`, `long`, `long long` (including their signed and unsigned variants).
`long long`- The **integral types** are `bool`, the various char types, and the standard integer types.

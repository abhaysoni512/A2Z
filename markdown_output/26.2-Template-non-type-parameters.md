...
> **Author:** Alex
> **Date:** Alex June 19, 2008, 7:07 pm PDT September 11, 2023
...
One noteworthy thing about the above example is that we do not have to dynamically allocate the m\_array member variable! This is because for any given instance of the StaticArray class, size must be constexpr. For example, if you instantiate a StaticArray<int, 12>, the compiler replaces size with 12. Thus m\_array is of type int[12], which can be allocated statically.

...
> **Author:** Alex
> **Date:** Alex April 23, 2019, 12:57 pm PDT February 11, 2025
...
*If statements* only conditionally execute a single statement. We talk about how to conditionally execute multiple statements in lesson [8.2 -- If statements and blocks](https://www.learncpp.com/cpp-tutorial/if-statements-and-blocks/).
...
Using the logical OR (||) operator ([6.8 -- Logical operators](https://www.learncpp.com/cpp-tutorial/logical-operators/)):
...
Using a switch statement ([8.5 -- Switch statement basics](https://www.learncpp.com/cpp-tutorial/switch-statement-basics/)):

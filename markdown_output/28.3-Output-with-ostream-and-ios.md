...
> **Author:** Alex
> **Date:** Alex March 12, 2008, 3:10 pm PDT March 16, 2024
...
In the lesson on [streams](https://www.learncpp.com/cpp-tutorial/131-input-and-output-io-streams/), you saw that both istream and ostream were derived from a class called ios. One of the jobs of ios (and ios\_base) is to control the formatting options for output.
...
|  | std::ios::showpos | If set, prefix positive numbers with a + |
| Group | Flag | Meaning |
 Group | Flag | Meaning ||  | std::ios::showpos | If set, prefix positive numbers with a + |
  | std::ios::showpos | If set, prefix positive numbers with a + |
...
|  | std::ios::uppercase | If set, uses upper case letters |
| Group | Flag | Meaning |
 Group | Flag | Meaning ||  | std::ios::uppercase | If set, uses upper case letters |
  | std::ios::uppercase | If set, uses upper case letters |

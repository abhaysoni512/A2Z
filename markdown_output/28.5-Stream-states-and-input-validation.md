...
> **Author:** Alex
> **Date:** Alex March 25, 2008, 3:21 pm PDT September 9, 2024

---

Stream states

The ios\_base class contains several state flags that are used to signal various conditions that may occur when using streams:
...
Although these flags live in ios\_base, because ios is derived from ios\_base and ios takes less typing than ios\_base, they are generally accessed through ios (e.g. as std::ios::failbit).

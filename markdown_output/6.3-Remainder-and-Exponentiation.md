...
> **Author:** Alex
> **Date:** Alex August 17, 2019, 11:57 am PDT December 30, 2024
...
We cover asserts in lesson [9.6 -- Assert and static\_assert](https://www.learncpp.com/cpp-tutorial/assert-and-static_assert/), and constexpr functions in lesson [F.1 -- Constexpr functions](https://www.learncpp.com/cpp-tutorial/constexpr-functions/).
...
Hint: You may need to use if-statements and the comparison operator (==) for this program. See lesson [4.9 -- Boolean values](https://www.learncpp.com/cpp-tutorial/boolean-values/) if you need a refresher on how to do this.
